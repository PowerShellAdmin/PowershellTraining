...
Help Get-IpamAddress -ShowWindow
Help Set-IpamAddress -ShowWindow
Help  Get-NetTCPConnection -ShowWindow
...
Get-VM
Start-VM -ComputerName VM1
Stop-VM -ComputerName VM1
New-VM -Name PSVM -MemoryStartupBytes 1GB -BootDevice CD -NewVHDPath E:\Globomantics\PSVM\psvm.vhdx -NewVHDSizeBytes 100GB -PathE:\Globomantics\PSVM\ -Generation 2 